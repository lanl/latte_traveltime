...
if __name__ == '__main__':
    ...
    if opts.input is not None:
        ...
        img['fsem'] = read_array(opts.input + '.fsem', (1, 1, n1, n2, n3))
        img['fdip'] = read_array(opts.input + '.fdip', (1, 1, n1, n2, n3))
        img['fstrike'] = read_array(opts.input + '.fstrike', (1, 1, n1, n2, n3))
        ...
        for iter in range(opts.niter):
            with torch.no_grad():
                ...
                img['fstrike'] = img['fstrike'].to(device)
                predict = net(img)
                ...
                if opts.niter > 1:
                    ...
                    if opts.save_iter:
                        ...
                        write_array(get_numpy(predict['fstrike']), opts.output + '.fstrike.iter' + str(iter))
